        ...
        <>
            <div className="absolute  bottom-28 left-0 w-full overflow-hidden leading-[0]">
                ...
                <svg
                    ...
                    className="w-full h-[100px] z-0 !bg-transparent"
                >
            ...
            <div className="container mt-28 min-h-screen flex flex-col items-center justify-center relative bg-white z-10">
